    ...
    <div className="mainPage">
      <header className="header">
        <div className="more btn">
          <div className="menuItem" onClick={toAbout}>
            <svg
        ...
        <div className="score btn">
          <span className="smallSpan">已猜中：</span>
          {guessedNum}
        </div>
      </header>
      ...
      <div className="bottomBar">
        <div className="toAchieve">
          <Link to={"/films/achieve"}>已猜中</Link>
        </div>
        <div className="guessBtn" onClick={() => guess()}>
          猜片名
        </div>
        <div className="passBtn" onClick={() => jump()}>
          &nbsp;&nbsp;跳过&nbsp;&nbsp;
        </div>
      </div>
      {showInputBox === true && pic.length > 0 ? (
        <InputBox setShow={setShowInputBox} filmName={pic[0].name}></InputBox>
      ) : null}
    </div>
  );
}
